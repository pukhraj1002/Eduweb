  ...
  const sections = {
    "PLACEMENT-PREPARATION": [
      ...
      },
      {
        ...
        icon: "https://images.javatpoint.com/static/img/logo.png",
      ...
      },
      {
        ...
        icon: "https://www.stonebridge.uk.com/images/stonebridge-associated-college-logo.png?v=2",
        description: "For Interview Behaviour",
      },
      {
        name: "SimpliLearn",
        url: "https://www.simplilearn.com/group-discussion-tips-article",
        icon: "https://www.simplilearn.com/ice9/new_logo.svgz",
        description: "For Group Description",
      },
      {
        name: "EnhanCV",
